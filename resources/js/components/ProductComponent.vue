                ...
                <div class="card shadow-sm rounded-lg border-0">
                    <div class="card-header bg-white border-0 d-flex align-items-center justify-content-between" style="min-height: 70px;">
                        <h4 class="card-title mb-0 fw-bold text-dark" style="font-size: 1.7rem; letter-spacing: 0.5px;">
                            Product <span class="mx-2">|</span> <span class="badge bg-primary text-white ms-2" style="font-size: 1rem;">{{totalProduct}}</span>
                        </h4>
                            ...
                            <table class="table table-hover table-borderless align-middle mb-0 overflow-hidden" style="border-radius: 1.2rem; background: #fafbfc;">
                                <thead class="table-light" style="border-radius: 1.2rem 1.2rem 0 0;">
                                    <tr style="font-size: 1rem; border-radius: 1.2rem 1.2rem 0 0; overflow: hidden;">
                                        <th scope="col" class="fw-medium text-dark py-3 border-0 border-bottom text-start" style="letter-spacing:0.02em; border-top-left-radius: 1.2rem; border-bottom: 1.5px solid #e5e7eb; background: #f8f9fa;">Product Id</th>
                                        ...
                                        <th scope="col" class="fw-medium text-dark py-3 border-0 border-bottom text-start" style="letter-spacing:0.02em; background: #f8f9fa;">Product Category</th>
                                        <th scope="col" class="fw-medium text-dark py-3 border-0 border-bottom text-start" style="letter-spacing:0.02em; background: #f8f9fa;">Product Code</th>
                                ...
                                <tbody>
                                    <tr v-for="product in products" :key="product.id" class="bg-white border-bottom border-light" style="vertical-align: middle; transition: background 0.2s;">
                                        <th scope="row" class="text-muted text-start">{{ product.id }}</th>
                                        <td class="text-start">{{ product.name}}</td>
                                        <td class="text-start">{{ product.cat_name }}</td>
                                        <td class="text-start">{{ product.code }}</td>
                                        <td class="text-start">
                                            <button type="button" @click.prevent="show(product)" class="btn btn-light border-0 btn-sm rounded-circle me-1 shadow-none" title="View">
                                                <i class="fas fa-eye text-primary"></i>
                                            </button>
                                            <button type="button" @click.prevent="edit(product)" class="btn btn-light border-0 btn-sm rounded-circle me-1 shadow-none" title="Edit">
                                                <i class="fas fa-edit text-success"></i>
                                            </button>
                                            <button type="button" @click.prevent="destroy(product)" class="btn btn-light border-0 btn-sm rounded-circle shadow-none" title="Delete">
                        ...
                        <div class="modal-body">
                          <alert-error :form="form" message="There were some problems with your input."></alert-error>
                                ...
                                <select v-model="form.cat_name" name="cat_name"
                                    class="form-control rounded-pill" :class="{ 'is-invalid': form.errors.has('cat_name') }" placeholder="Select Category">
                                ...
                                <label>Product Description</label>
                                    <textarea v-model="form.description" name="description" rows="3" class="form-control rounded-4"
